        ...
        <form id="newgalfrm">
            <div class="row mb-2 margin1050">
                ...
                <div class="col-6 text-right mb-2">
                    <button type="button" class="btn btn-light" id="listgalbtn"><i class="bi bi-card-list bidragup">목록</i></button>
                </div>
            </div><!-- 상단버튼 -->
                ...
                <!--파일 첨부 시작 -->
                    <div class="form-group row">
                        ...
                        <div class="custom-file col-9">
                            <input type="file" id="fname1" name="img" class="custom-file-input">
                            <label class="custom-file-label">업로드할 이미지 파일을 선택하세요.</label>
                        </div>
                        <div class="custom-file col-9 offset-2">
                            <input type="file" id="fname2" name="img" class="custom-file-input">
                            <label class="custom-file-label">업로드할 이미지 파일을 선택하세요.</label>
                        </div>
                        <div class="custom-file col-9 offset-2">
                            <input type="file" id="fname3" name="img" class="custom-file-input">
                            <label class="custom-file-label">업로드할 이미지 파일을 선택하세요.</label>
                        </div>
                    </div>
                <!--파일 첨부 끝! -->
            ...
            <div class="row">
               <div class="col-12 text-center">
                   <button type="button" class="btn btn-primary" id="newgalbtn"><i class="bi bi-check">입력완료</i></button>
